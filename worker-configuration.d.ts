/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 9db7ddb0dd90595b3685c68f295ebbe1)
// Runtime types generated with workerd@1.20260921.1 2026-08-25 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_Env {
	TRADE_RECORDS: KVNamespace;
	TRADE_RECORD_CREATE_RATE_LIMITER: RateLimit;
	TRADE_RECORD_READ_RATE_LIMITER: RateLimit;
	LIGHTNING_REQUEST_RATE_LIMITER: RateLimit;
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "TradeRecordState";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DEPLOYMENT_ENV" | "TRADE_RECORDS_ENABLED" | "TRADE_RECORD_SIGNING_KEY">> {}
}
