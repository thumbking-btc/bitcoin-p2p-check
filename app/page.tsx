...
import previewStyles from "./payment-preview.module.css";
    ...
    <>
      <main className="site-main">
        <section
          ...
          className={`trade-tool ${previewStyles.previewShell}`}
          aria-label="BTC 수취 요청 실험 프리뷰"
        >
      ...
      <div className={previewStyles.standardExtras}>
