  ...
  return (
    <>
      <main className="privacy-page">
        ...
        <header>
          <p className="section-label">시행일 · 2026년 8월 25일</p>
          <h1>개인정보·데이터 안내</h1>
        ...
        <div className="privacy-content">
          ...
          <section aria-labelledby="public-record-title">
            ...
            <ul>
              ...
              <li>서버는 금액과 결제정보를 다시 확인한 뒤 15분 후 자동 폐기되는 비공개 준비 기록을 만듭니다. 실제 공유를 완료한 기록만 확정하여 최대 180일간 보관합니다. 원본 확인 링크를 아는 사람은 만료 또는 철회 전까지 내용을 볼 수 있으므로 공개 링크처럼 취급해야 합니다.</li>
              <li>생성한 브라우저에 철회 권한이 남아 있는 동안에는 공유 화면의 철회 기능으로 기록을 조기 삭제할 수 있습니다. 확인 링크만 가진 사람에게는 철회 권한이 없습니다.</li>
