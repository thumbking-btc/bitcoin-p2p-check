...
- WebSocket 연결 실패가 계속되면 12초부터 시작해 최대 2분까지 재연결 간격을 늘립니다. 백그라운드 또는 오프라인 상태에서는 재연결을 시도하지 않습니다.
...
수동 배포가 필요한 비상 상황에서는 Cloudflare 로그인 후 아래 명령으로 정적 PWA와 시세 전용 Worker를 함께 배포할 수 있습니다.
